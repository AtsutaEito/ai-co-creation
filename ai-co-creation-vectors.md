...
<div style="width: 100%; max-width: 100%; margin-bottom: 48px; box-sizing: border-box;">
  <img src="assets/images/ai-co-creation-vectors.png" alt="AI共創の二大系統" style="width: 100% !important; max-width: 100% !important; height: auto !important; display: block !important; border-radius: 8px !important;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
  <div style="display: none; width: 100%; height: 200px; border: 1px dashed rgba(255, 255, 255, 0.1); border-radius: 8px; align-items: center; justify-content: center; color: #94a3b8; font-size: 13px; font-weight: 600;">[ AI共創の二大系統 ヘッダー画像 ]</div>
</div>
